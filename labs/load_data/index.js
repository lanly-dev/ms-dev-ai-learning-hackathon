...
function cleanData(obj) {
  const cleaned = Object.fromEntries(Object.entries(obj).filter(([key, _]) => !key.startsWith('_')))
...
async function insertMany(db) {
  ...
  let result = await customerCollection.insertMany(customerData)
